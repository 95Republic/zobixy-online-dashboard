...
const SellerDetails = () => {
    ...
    return (
        <div className='px-2 lg:px-7 pt-5'>
            <h1 className='text-xl font-bold mb-3 text-[#5c5a5a]'>Seller Details</h1>
...
<div className='px-0 md:px-5 py-2'>
    <div className='py-2 text-lg'>
        ...
        bg-[#9e97e9] rounded-md'>
            ...
            <div className='flex gap-2 font-bold text-[#000000]'>
                <span>Shop Name : </span>
                <span>{seller?.shopInfo? 
                seller?.shopInfo?.shopName : <span>N/A</span>}</span>
            </div>

            <div className='flex gap-2 font-bold text-[#000000]'>
                <span>Division : </span>
                <span>{seller?.shopInfo? 
                seller?.shopInfo?.division : <span>N/A</span>}</span>
            </div>
            ...
            <div className='flex gap-2 font-bold text-[#000000]'>
                <span>District : </span>
                <span>{seller?.shopInfo? 
                seller?.shopInfo?.district : <span>N/A</span>}</span>
            </div>
            ...
            <div className='flex gap-2 font-bold text-[#000000]'>
                <span>State : </span>
                <span>{seller?.shopInfo ?
                 seller?.shopInfo?.sub_district : <span>N/A</span>}</span>
            </div>
...
{/* Address section end--------------------- */}
                ...
                <div>
                    <form onSubmit={submit}>
                        ...
                        <button className='bg-red-500 w-[170px] hover:shadow-red-500/40 hover:shadow-md text-white 
                        rounded-md px-7 py-2'>Submit</button>
