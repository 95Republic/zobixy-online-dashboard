                ...
                <table className='w-full text-sm text-left text-[#d0d2d6]'>
                    ...
                    <tbody>
                        ...
                        
                        {
                            ...
                            <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>Mens shirt</td>
                            <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>Sports</td>
                            <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>NUMERO UNO</td>
                            <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>R564</td>
                            <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>10%</td>
                            <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>30</td>
                            <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>
